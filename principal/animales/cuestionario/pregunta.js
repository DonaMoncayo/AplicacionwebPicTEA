...
let foca = new Audio('./../audios/foca.mp3');
let sapo = new Audio('./../audios/sapo.mp3');
let gato = new Audio('./../audios/gato.mp3');
let nu = new Audio('./../audios/nu.mp3');
let pato = new Audio('./../audios/pato.mp3');
