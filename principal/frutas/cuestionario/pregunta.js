...
let pera = new Audio('./../audios/pera.mp3');
let limon = new Audio('./../audios/limon.mp3');
let sandia = new Audio('./../audios/sandia.mp3');
let kiwi = new Audio('./../audios/kiwi.mp3');
let cereza = new Audio('./../audios/cereza.mp3');
