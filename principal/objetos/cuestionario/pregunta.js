...
let casa = new Audio('./../audios/casa.mp3');
let dado = new Audio('./../audios/dado.mp3');
let barco = new Audio('./../audios/barco.mp3');
let hoja = new Audio('./../audios/hoja.mp3');
let jarra = new Audio('./../audios/jarra.mp3');
